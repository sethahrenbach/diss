...
With this formulation of \DASL, we can iterate over each schema and prove that it is a Sahlqvist implication, which we do in the following $\mathtt{Theorem}$:
