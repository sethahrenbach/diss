...
This section describes the Coq Proof Assistant \cite{coq_ref} and the Z3 SMT Solver that this dissertation makes use of. We use Coq to mechanically check our metatheory proofs of soundness and completeness, and our object theory proofs about safety-critical information flow. We use the Z3 SMT Solver to automatically infer missing safety-critical information based on an unsafe input action. This serves as a proof of concept for potential safety-critical information monitors that make use of \DASL\ as their foundation.
