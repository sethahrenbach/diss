...
Conversely, Hintikka rejects (3) because he does not find it plausible that $\Bels{i}\varphi \iimplies \Kns{i}\Poss{i}\varphi$, which (3) and the Truth Axiom jointly imply.
