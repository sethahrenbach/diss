...
\vspace*{\fill}
\centerline{\large{\bf DYNAMIC AGENT SAFETY LOGIC:}} % The title on the Title Page must be in all caps.
\centerline{\large{\bf THEORY AND APPLICATIONS}}
\vskip 10mm
...
\centerline{JULY 2019} % The month is required to be capitalized.  Use the month and year of your graduation, not the month and year you defend.
\vspace*{\fill}
